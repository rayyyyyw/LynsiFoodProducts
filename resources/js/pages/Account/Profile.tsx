...
function Field({
    ...
    return (
        <div>
            ...
            {hint && !error && (
                <p style={{ fontSize: 12, color: P.textLight, marginTop: 5 }}>
                    {hint}
                </p>
            )}
        </div>
    ...
    function handlePhotoSelect(e: React.ChangeEvent<HTMLInputElement>) {
        ...
        router.post('/settings/profile', fd, {
            ...
            onError: (errs) => {
                ...
                setPhotoUploading(false);
                setPhotoError(
                    errs.profile_photo ?? 'Upload failed. Please try again.',
                );
            },
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
            ...
            <div
                style={{
                    ...
                    textAlign: 'center',
                    background: `linear-gradient(160deg, ${P.accentBg} 0%, ${P.white} 100%)`,
                    ...
                    {preview ? (
                        <img
                            ...
                            style={{
                                ...
                                boxShadow: '0 4px 14px rgba(6,95,70,0.18)',
                        ...
                        <div
                            style={{
                                ...
                                fontWeight: 800,
                                border: `3px solid ${P.white}`,
                                boxShadow: '0 4px 14px rgba(6,95,70,0.22)',
                            }}
                        >
                                ...
                                {menuOpen && (
                                    <div
                                        style={{
                                            ...
                                            padding: 6,
                                            zIndex: 200,
                                            animation: 'acc-fade-in 0.16s ease',
                                        }}
                                    >
                                        <div
                                            style={{
                ...
                >
                    ...
                    <button
                        ...
                        style={{
                            ...
                            border: 'none',
                            cursor: 'pointer',
                            boxShadow: '0 6px 20px rgba(6,95,70,0.4)',
                            display: 'flex',
                            alignItems: 'center',
                            justifyContent: 'center',
                        }}
                                                    ...
                                                    {preview ? (
                                                        ...
                                                        <div
                                                            style={{
                                                                ...
                                                                borderRadius:
                                                                    '50%',
                                                                background: `linear-gradient(135deg, ${P.accentBg}, #e0f2fe)`,
                                                                display: 'flex',
                                                                alignItems:
                                                                    'center',
                                                                justifyContent:
                                                            ...
                                                            <span
                                                                style={{
                                                                    ...
                                                                    display:
                                                                        'inline-block',
                                                                    animation:
                                                                        'acc-spin 0.75s linear infinite',
                                                                }}
                                                            />
                                                        </div>
                                                    )}
                        ...
                        {tab === 'delete' && (
                            ...
                            >
                                <div
                                    style={{
                                        padding: '22px 28px',
                                        borderBottom: `1px solid ${P.dangerBorder}`,
                                ...
                                <div style={{ padding: '32px 28px' }}>
                                    ...
                                    >
                                        ...
                                        >
                                            Once deleted, all your data —
                                            orders, saved addresses, and profile
                                            information — will be{' '}
