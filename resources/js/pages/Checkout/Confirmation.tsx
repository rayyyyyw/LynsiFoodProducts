        ...
        <>
            ...
            >
                ...
                >
                    ...
                    >
                        Thank you, <strong>{order.shipping_name}</strong>! We've
                ...
                >
                    Below is a summary of your order. You can track its status
                    in your account.
                </p>
                ...
                >
                    ...
                    >
                        {/* Delivery Info */}
                        <section
                            className="fade-up conf-section delay-2"
                            style={{
                                background: P.card,
                                borderRadius: 18,
                                border: `1px solid ${P.border}`,
