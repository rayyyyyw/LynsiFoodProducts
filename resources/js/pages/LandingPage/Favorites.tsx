            ...
            >
                ...
                <main className="min-h-0 flex-1 px-3 py-4 sm:px-4 sm:py-6">
                    <div className="mx-auto max-w-7xl">
                        <div className="mb-4 flex flex-wrap items-center justify-between gap-2">
                            <div>
                                ...
                                <p className="text-xs text-neutral-500 sm:text-sm">
                                    Quick access to products you love. Review
                                    variant options, then add to cart.
                                </p>
                            </div>
                        ...
                        {favoriteProducts.length === 0 ? (
                            <div
                                className="rounded-xl border border-dashed px-4 py-12 text-center text-neutral-600"
                            ...
                            <div className="grid gap-4 sm:gap-5 md:grid-cols-2 xl:grid-cols-3">
                                {favoriteProducts.map((product) => {
                                    ...
                                    const isAdding = product.variants.some(
                                        (v) => addingId === v.id,
                                    );
                                    ...
                                    return (
                                        <div
                                            key={product.id}
                                            className="overflow-hidden rounded-2xl border bg-white transition-all duration-200 hover:scale-[1.02] hover:border-emerald-400 hover:shadow-lg"
                                            style={{
                                        ...
                                        >
                                            ...
                                            >
                                                <div className="relative flex justify-center bg-neutral-100 px-4 pt-4 pb-2 sm:px-6 sm:pt-6">
                                                    <div
                                                        className="relative h-28 w-28 shrink-0 overflow-hidden rounded-full border-2 border-white shadow-md sm:h-32 sm:w-32 lg:h-36 lg:w-36"
                                                        style={{
                                                            borderColor:
                                                                PALETTE.border,
                                                        }}
                                            ...
                                            {/* Add to Cart button */}
                                            <div
                                                className="px-3 pt-1 pb-3 sm:px-3 sm:pt-2 sm:pb-3"
