        ...
        <>
                ...
                <main className="min-h-0 flex-1 px-3 py-4 sm:px-4 sm:py-6">
                    <div className="mx-auto max-w-7xl">
                        ...
                        <div className="mb-4 flex flex-col gap-3 sm:mb-6 sm:flex-row sm:items-center sm:gap-4">
                            <div className="relative flex-1">
                                ...
                                <input
                                    ...
                                    className="w-full rounded-lg border border-neutral-300 bg-white py-2.5 pr-4 pl-10 text-neutral-900 placeholder:text-neutral-500 focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 focus:outline-none"
                                />
                            </div>
                            <button
                                type="button"
                        ...
                        <div className="flex flex-col gap-3 lg:flex-row lg:gap-6">
                            ...
                            >
                                <h3 className="mb-2 text-xs font-semibold text-neutral-900 sm:text-sm">
                                    Filters
                                </h3>

                                <div className="mb-3 sm:mb-4">
                                    <h4 className="mb-1.5 text-[11px] font-medium tracking-wide text-neutral-500 uppercase sm:text-xs">
                                        CATEGORY
                                    </h4>
                                    <div className="flex flex-col gap-0.5 sm:gap-1">
                                        <button
                                            ...
                                            className="min-h-[40px] touch-manipulation rounded-lg px-2.5 py-1.5 text-left text-xs font-medium transition-colors sm:min-h-0 sm:px-3 sm:py-2 sm:text-sm"
                                            style={{
                                                background:
                                                    categoryId === 'all'
                                                        ? PALETTE.bg
                                        ...
                                        {categories.map((cat) => (
                                            <button
                                                ...
                                                className="min-h-[40px] touch-manipulation rounded-lg px-2.5 py-1.5 text-left text-xs transition-colors hover:bg-neutral-100 sm:min-h-0 sm:px-3 sm:py-2 sm:text-sm"
                                                style={{
                                                    background:
                                                        categoryId === cat.id
                                                            ? PALETTE.bg
                                    ...
                                    <div className="flex flex-col gap-1.5 sm:gap-2">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <input
                                                ...
                                                className="min-h-[36px] w-full rounded border border-neutral-300 bg-white px-2 py-1.5 text-xs text-neutral-900 placeholder:text-neutral-400 focus:border-emerald-500 focus:outline-none sm:text-sm"
                                            />
                                        </div>
                                        <div className="flex items-center gap-2">
                                            <span className="text-xs text-neutral-600 sm:text-sm">
                                        ...
                                        <button
                                            ...
                                            className="min-h-[38px] w-full touch-manipulation rounded-lg px-2.5 py-1.5 text-xs font-medium text-white sm:min-h-0 sm:px-3 sm:py-2 sm:text-sm"
                                            style={{
                            ...
                            <div className="min-w-0 flex-1">
                                ...
                                {filteredAndSorted.length === 0 ? (
                                    ...
                                    >
                                        No products match your filters. Try
                                        adjusting search or category.
                                    </div>
                                ) : (
                                    <div className="grid gap-3 sm:grid-cols-2 sm:gap-4 xl:grid-cols-3">
                                        {filteredAndSorted.map((product) => {
                                            ...
                                            const primaryVariant =
                                                product.variants[0];
                                            const flavorLabel =
                                                primaryVariant?.flavor ?? null;
                                            const rawSize =
                                                primaryVariant?.size ?? null;
                                            const sizeLabel =
                                                rawSize &&
                                                /^[0-9]+(\.[0-9]+)?$/.test(
                                                    rawSize,
                                            ...
                                            return (
                                                <div
                                                    key={product.id}
                                                    className="overflow-hidden rounded-xl border bg-white transition-all duration-200 hover:scale-[1.02] hover:border-emerald-400 hover:shadow-lg"
                                                    style={{
                                                        borderColor:
                                                            PALETTE.border,
                                                        display: 'flex',
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <div className="relative flex justify-center bg-neutral-100 px-4 pt-4 pb-2 sm:px-6 sm:pt-6">
                                                            <div
                                                                className="relative h-32 w-32 shrink-0 overflow-hidden rounded-full border-2 border-white shadow-md sm:h-40 sm:w-40"
                                                                style={{
                                                                    borderColor:
                                                                        PALETTE.border,
                                                                }}
                                                        ...
                                                        <div className="px-2.5 pt-2.5 pb-1 sm:px-3 sm:pt-3">
                                                            <span className="mb-1 inline-block text-xs font-medium tracking-wide text-slate-500 uppercase">
                                                                {categoryName.length >
                                                                12
                                                                    ? `${categoryName.slice(0, 12)}…`
                                                                    : categoryName}
                                                            </span>
                                                            <h3 className="mb-1 line-clamp-2 font-semibold text-slate-800">
                                                                {product.name}
                                                            </h3>
                                                            {(flavorLabel ||
                                                                sizeLabel) && (
                                                                <div className="mb-1.5 space-y-0.5 text-xs leading-snug">
                                                                    {flavorLabel && (
                                                    ...
                                                    {/* Add to Cart button */}
                                                    <div
                                                        className="px-2.5 pt-1 pb-3 sm:px-3 sm:pt-2 sm:pb-3"
                                                        style={{
                                                            marginTop: 'auto',
                                                        }}
                                                    >
            ...
            {picker && (
                ...
                >
                    <div
                        ref={pickerRef}
                        className="w-full max-w-[400px] rounded-2xl p-4 sm:p-6"
                        style={{
                            background: '#fff',
                    ...
                    >
                                        ...
                                        return (
                                            <button
                                                ...
                                                style={{
                                                    ...
                                                    padding: '10px 13px',
                                                    borderRadius: 10,
                                                    border: `1.5px solid ${selected ? PALETTE.accent : '#e5e7eb'}`,
                                                    background: selected
                                                        ? '#ecfdf5'
                                                        : '#fff',
                                                    cursor: 'pointer',
                        ...
                        >
                            ...
                            >
                                ...
                                <button
                                    type="button"
                                    disabled={pickerQty >= pickerMaxQty}
                                    onClick={() =>
                                        setPickerQty((q) =>
                                            Math.min(pickerMaxQty, q + 1),
                                        )
                                    }
                                    style={{
                                        width: 38,
                        ...
                        <button
                            ...
                            style={{
                                ...
                                fontSize: 14,
                                cursor:
                                    addingId || !pickerVariant?.stock_quantity
                                        ? 'not-allowed'
                                        : 'pointer',
                                fontFamily: "'Inter', sans-serif",
                                display: 'flex',
                        ...
                        >
                            {addingId ? (
                                ...
                                <>
                                    <ShoppingCart size={15} /> Add {pickerQty}{' '}
                                    to Cart — ₱
                                    {pickerVariant
                                        ? Number(
                                              pickerVariant.price * pickerQty,
                                          ).toLocaleString('en-PH', {
                                              minimumFractionDigits: 2,
                                          })
                                        : '0'}
