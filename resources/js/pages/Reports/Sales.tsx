...
import { BadgeCheck, Clock3, Coins, CreditCard, Receipt } from 'lucide-react';
import {
    Card,
    CardContent,
    CardDescription,
...
function statusStyle(status: string): string {
    ...
    if (status === 'processing' || status === 'shipped')
        return 'border-blue-300 bg-blue-50 text-blue-800 dark:border-blue-700 dark:bg-blue-950/40 dark:text-blue-300';
    if (status === 'delivered')
            ...
            <div className="flex h-full flex-1 flex-col gap-6 overflow-x-auto p-4 md:p-6">
                <div className="flex flex-wrap items-end justify-between gap-3">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-muted-foreground">
                            Revenue, payments, and order performance in one
                            place.
                        </p>
                    </div>
                ...
                <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-5">
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold">
                                {peso(data.summary.pending_sales)}
                            </div>
                        </CardContent>
                    </Card>
                    <Card>
                ...
                <div className="grid gap-6 lg:grid-cols-3">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                How orders are distributed by status.
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-2 text-sm">
                            ...
                            <div className="flex items-center justify-between rounded border p-2">
                                ...
                                <span className="font-semibold">
                                    {data.status_counts.processing}
                                </span>
                            </div>
                            <div className="flex items-center justify-between rounded border p-2">
                                <span>Delivered</span>
                                <span className="font-semibold">
                                    {data.status_counts.delivered}
                                </span>
                            </div>
                            <div className="flex items-center justify-between rounded border p-2">
                                <span>Cancelled</span>
